package com.tibebues.developer.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.tibebues.developer.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.tibebues.developer.repository.UserRepository.USERS_BY_EMAIL_CACHE);
