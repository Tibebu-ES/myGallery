  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="tibeGalleryApp.album.home.createOrEditLabel">
            <Translate contentKey="tibeGalleryApp.album.home.createOrEditLabel">Create or edit a Album</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : albumEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="titleLabel" for="album-title">
                  <Translate contentKey="tibeGalleryApp.album.title">Title</Translate>
                </Label>
                <AvField
                  id="album-title"
                  type="text"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="album-description">
                  <Translate contentKey="tibeGalleryApp.album.description">Description</Translate>
                </Label>
                <AvInput id="album-description" type="textarea" name="description" />
              </AvGroup>
              <AvGroup>
                <Label id="createdLabel" for="album-created">
                  <Translate contentKey="tibeGalleryApp.album.created">Created</Translate>
                </Label>
                <AvInput
                  id="album-created"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label for="album-user">
                  <Translate contentKey="tibeGalleryApp.album.user">User</Translate>
                </Label>
