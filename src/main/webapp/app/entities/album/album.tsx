...
export const Album = (props: IAlbumProps) => {
  ...
  return (
    <div>
      <h2 id="album-heading">
        <Translate contentKey="tibeGalleryApp.album.home.title">Albums</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="tibeGalleryApp.album.home.createLabel">Create new Album</Translate>
        </Link>
      </h2>
        ...
        {albumList && albumList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="tibeGalleryApp.album.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="tibeGalleryApp.album.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('created')}>
                  <Translate contentKey="tibeGalleryApp.album.created">Created</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="tibeGalleryApp.album.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="tibeGalleryApp.album.home.notFound">No Albums found</Translate>
            </div>
          )
        )}
      </div>
