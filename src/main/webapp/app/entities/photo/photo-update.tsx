  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="tibeGalleryApp.photo.home.createOrEditLabel">
            <Translate contentKey="tibeGalleryApp.photo.home.createOrEditLabel">Create or edit a Photo</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : photoEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="titleLabel" for="photo-title">
                  <Translate contentKey="tibeGalleryApp.photo.title">Title</Translate>
                </Label>
                <AvField
                  id="photo-title"
                  type="text"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="photo-description">
                  <Translate contentKey="tibeGalleryApp.photo.description">Description</Translate>
                </Label>
              ...
              <AvGroup>
                <AvGroup>
                  <Label id="imageLabel" for="image">
                    <Translate contentKey="tibeGalleryApp.photo.image">Image</Translate>
                  </Label>
                  <br />
                  {image ? (
                    <div>
              ...
              <AvGroup>
                <Label for="photo-tag">
                  <Translate contentKey="tibeGalleryApp.photo.tag">Tag</Translate>
                </Label>
                <AvInput
                  id="photo-tag"
                  type="select"
