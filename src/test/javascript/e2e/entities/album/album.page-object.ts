...
export class AlbumDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('tibeGalleryApp.album.delete.question'));
...
export default class AlbumComponentsPage {
  ...
  async deleteAlbum() {
    ...
    expect(await albumDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/tibeGalleryApp.album.delete.question/);
