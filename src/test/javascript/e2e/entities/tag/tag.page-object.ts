...
export class TagDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('tibeGalleryApp.tag.delete.question'));
...
export default class TagComponentsPage {
  ...
  async deleteTag() {
    ...
    expect(await tagDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/tibeGalleryApp.tag.delete.question/);
