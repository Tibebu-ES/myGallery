...
export class PhotoDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('tibeGalleryApp.photo.delete.question'));
...
export default class PhotoComponentsPage {
  ...
  async deletePhoto() {
    ...
    expect(await photoDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/tibeGalleryApp.photo.delete.question/);
